...
function actionClassName(tone: MyLearningCardAction["tone"] = "ghost", disabled?: boolean) {
  return cn(
    ...
    tone === "primary" &&
      "bg-[linear-gradient(135deg,#F97316,#FB923C)] text-white shadow-[0_12px_30px_rgba(249,115,22,0.22)] hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(249,115,22,0.28)]",
    tone === "secondary" &&
      "border border-[rgba(249,115,22,0.22)] bg-[rgba(249,115,22,0.08)] text-[#FDBA74] hover:border-[rgba(249,115,22,0.34)] hover:bg-[rgba(249,115,22,0.12)]",
    tone === "ghost" &&
  ...
  return (
    <article className="group rounded-[24px] border border-[rgba(255,255,255,0.1)] bg-[linear-gradient(180deg,rgba(15,23,42,0.9),rgba(15,23,42,0.74))] p-5 shadow-[0_18px_42px_rgba(2,6,23,0.34)] transition hover:border-[rgba(249,115,22,0.24)] hover:shadow-[0_22px_48px_rgba(15,23,42,0.44),0_0_32px_rgba(249,115,22,0.08)]">
      <div className="flex items-start gap-3">
        <div className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-[rgba(249,115,22,0.22)] bg-[rgba(249,115,22,0.12)] text-[12px] font-bold tracking-[0.08em] text-[#FDBA74]">
          {badge}
        </div>
      ...
      <div className="mt-5">
        <div className="mb-2 flex items-center justify-between text-[12px]">
          ...
          <span className="font-semibold text-[#FDBA74]">{progressLabel}</span>
        </div>
        <div className="h-2 rounded-full bg-[rgba(255,255,255,0.08)]">
          <div
            className="h-full rounded-full bg-[linear-gradient(90deg,#F97316,#FDBA74)]"
