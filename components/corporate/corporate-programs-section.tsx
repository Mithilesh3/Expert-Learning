...
function SectionList({ title, items }: { title: string; items: string[] }) {
  return (
    <div className="rounded-[18px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-4">
      <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FDBA74]">{title}</div>
          ...
          >
            ...
            >
              ...
              <div className="p-5 sm:p-6">
                <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FDBA74]">Enterprise Program</div>
                ...
                <div className="mt-5 grid gap-3 sm:grid-cols-3">
                  <div className="rounded-[16px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-4">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FDBA74]">Training Delivery</div>
                    <div className="mt-2 text-[13px] font-medium leading-6 text-white">{activeProgram.level}</div>
                  </div>
                  <div className="rounded-[16px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-4">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FDBA74]">Duration</div>
                    <div className="mt-2 text-[13px] font-medium leading-6 text-white">{activeProgram.duration}</div>
                  </div>
                  <div className="rounded-[16px] border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.03)] p-4">
                    <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FDBA74]">{activeProgram.supportLabel}</div>
        ...
        {inquiryOpen ? (
          ...
          >
            ...
            >
              ...
              <div className="p-5 sm:p-6">
                <div className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#FDBA74]">Enterprise Consultation</div>
                ...
                <form className="mt-5" onSubmit={handleInquirySubmit}>
                  ...
                  <div>
                    <label className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FDBA74]">Full Name</label>
                    <input
                  ...
                  <div>
                    <label className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FDBA74]">Company Name</label>
                    <input
                      className={fieldClass}
                  ...
                  <div>
                    <label className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FDBA74]">Work Email</label>
                    <input
                      type="email"
                      className={fieldClass}
                  ...
                  <div>
                    <label className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FDBA74]">Phone Number</label>
                    <input
                      type="tel"
                      className={fieldClass}
                  ...
                  <div>
                    <label className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FDBA74]">Interested Program</label>
                    <select
                  ...
                  <div className="mt-3">
                    <label className="mb-2 block text-[10px] font-semibold uppercase tracking-[0.12em] text-[#FDBA74]">Message</label>
                    <textarea
