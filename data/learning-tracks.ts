...
export const learningTracks: LearningTrack[] = [
  {
    ...
    icon: "AI",
    accentClass: "border-[#A78BFA]/30 bg-[#A78BFA]/10 text-[#DDD6FE]",
  ...
  },
  {
    ...
    icon: "AG",
    accentClass: "border-[#60A5FA]/30 bg-[#60A5FA]/10 text-[#BFDBFE]",
  ...
  },
  {
    ...
    icon: "AWS",
    accentClass: "border-[#2563EB]/30 bg-[#2563EB]/10 text-[#FED7AA]",
